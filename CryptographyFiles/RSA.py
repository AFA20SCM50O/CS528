...
def generate_keys():
    ...
    with open('CryptographyFiles/keys/pubkey.pem', 'wb') as f:
        f.write(pubKey.save_pkcs1('PEM'))

    with open('CryptographyFiles/keys/privkey.pem', 'wb') as f:
        f.write(privKey.save_pkcs1('PEM'))

def load_keys():
    with open('CryptographyFiles/keys/pubkey.pem', 'rb') as f:
        pubKey = rsa.PublicKey.load_pkcs1(f.read())

    with open('CryptographyFiles/keys/privkey.pem', 'rb') as f:
